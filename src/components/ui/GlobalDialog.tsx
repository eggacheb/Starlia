...
export const GlobalDialog: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center bg-black/60 dark:bg-black/80 px-4 animate-in fade-in duration-200">
      <div
      ...
      >
        <div className="flex flex-col items-center text-center">
          <div className={`mb-4 rounded-full p-3 ${dialog.type === 'alert'
          ...
          <div className="flex gap-3 w-full">
            ...
            <button
              ...
              className={`flex-1 rounded-lg px-4 py-2 text-sm font-medium text-white transition shadow-lg ${dialog.type === 'alert'
